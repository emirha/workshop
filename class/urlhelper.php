...
class Urlhelper {
    ...
    static function anchor($uri = '', $title = '', $attributes = '')
    {
        $title = (string) $title;
    ...
    static function anchor_popup($uri = '', $title = '', $attributes = FALSE)
    {
        $title = (string) $title;
    ...
    static function mailto($email, $title = '', $attributes = '')
    {
        $title = (string) $title;
    ...
    static function _parse_attributes($attributes, $javascript = FALSE)
    {
